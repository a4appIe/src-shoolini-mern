    ...
    <>
      ...
      <section className="bg-white text-gray-800 py-12 px-6 sm:px-10 lg:px-24">
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-lg font-medium mb-4">RESEARCH IS IN OUR DNA</p>
            <p className="text-gray-700 leading-relaxed">
              Shoolini is at the forefront of research internationally and
              attracts outstanding academics, research staff, and students from
              across the world. Shoolini researchers engage in cutting-edge
              research across disciplines and make groundbreaking contributions
              in science, engineering, business, and liberal arts. Our
              researchers are tackling key global challenges—from finding cures
              to diseases to ecological problems, agriculture, and myriad other
              issues.
            </p>
            <p className="text-gray-700 leading-relaxed mt-4">
              Our world-class resources include state-of-the-art research
              facilities, extensive grant and funding opportunities, and robust
              support networks dedicated to turning research into actionable
              innovations. We are committed to supporting our inspiring
              community of researchers to break new grounds and expand the
              frontiers of knowledge to help improve the human condition and the
              state of our planet.
            </p>
          </div>
        </div>
      ...
      <section className="bg-gray-800 text-white py-12 px-6 sm:px-10 lg:px-24">
        ...
        <div className="mt-8 text-sm text-gray-300">
          <p className="mb-4">
            <span className="font-bold">
              *FWCI (Field Weighted Citation Score)
            </span>{" "}
            is an indication of the contribution of a university to the sum of
            human knowledge – and signals research that has stood out and is
            shared across the global community of researchers.
          </p>
          <p className="mb-4">
            The table indicates the FWCI and research parameters of select
            universities, tracked by us for comparison, for the period
            2017–2019. It is possible there are institutions across the globe as
            well as in the country with higher scores on similar indexes.
          </p>
        </div>
        ...
        <div className="mt-4 text-center">
          <Link
            to={"/pricing"}
            className="bg-red hover:bg-pink-800 font-semibold py-2 px-6 rounded-lg"
          >
            Join
          </Link>
        </div>
