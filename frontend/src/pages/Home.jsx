...
const Home = () => {
  return (
    <div
      className="min-h-[80vh] flex flex-col items-center justify-center gap-10 p-5 pt-20"
      style={{
    ...
    >
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 lg:gap-10 mt-10 border border-black bg-slate-500/[.3] p-2 rounded-md">
        ...
        <div className="flex flex-col items-center text-center w-28 sm:w-32 lg:w-40">
          ...
          <p className="font-semibold text-lg lg:text-2xl mt-2 text-gray-700">6</p>
          <p className="text-sm lg:text-md text-gray-700">Research Uploads</p>
        </div>
        <div className="flex flex-col items-center text-center w-28 sm:w-32 lg:w-40">
          <FaBook className="text-4xl lg:text-5xl text-gray-800" />
          <p className="font-semibold text-lg lg:text-2xl mt-2 text-gray-700">5</p>
