...
const PricingCard = () => {
  return (
    <div className="rounded-2xl shadow-lg p-3 bg-darkRed text-gray-600 max-w-md min-h-[75vh]">
      <div className="relative flex flex-col items-center p-5 pt-10 bg-blue-100 rounded-xl h-full">
        ...
        <p className="text-xl font-semibold text-darkRed bg-indigo-200 px-2 py-1 rounded-lg">
          Professional
        </p>
